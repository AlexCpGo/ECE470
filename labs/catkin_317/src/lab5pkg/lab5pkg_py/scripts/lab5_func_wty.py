...
def lab_invk(xWgrip, yWgrip, zWgrip, yaw_WgripDegree):
	...
	# theta1
	tempL=l02-l04+l06
	length_XY=(xcen**2+ycen**2)**(0.5)
	thetas[0] = math.atan2(ycen, xcen)-math.asin(tempL/length_XY)  # Default value Need to Change
	thetax=math.asin(tempL/length_XY)

	# theta6
	thetas[5] = PI/2     # Default value Need to Change
 
	l3end = length_XY*math.cos(thetax)-l07

	x3end = l3end*math.cos(thetas[0])
	y3end = l3end*math.sin(thetas[0])
	
	z3end = zcen+l10+l08
	#print([x3end,y3end,z3end])
	tempL2=(x3end**2+y3end**2+(z3end-l01)**2)**(0.5)
	
	#print((tempL2**2-l03**2-l05**2)/(-2*l03*l05))
	thetas[2]= PI-math.acos((tempL2**2-l03**2-l05**2)/(-2*l03*l05))
	
	theta21=math.asin((z3end-l01)/tempL2)
	theta22=math.acos((l05**2-l03**2-tempL2**2)/(-2*l03*tempL2))
	thetas[1]= -theta22-theta21
